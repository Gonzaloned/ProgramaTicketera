...
class Pantalla3(object):
    ...
    def solicitarAtencion(self,tipo):
        ...
        if (self.db.queryExecution(QUERY)):
            ...
            if(query_data.first()):
                ...
                node_param.append(str(round(numero_agregado)))
                ...
                if tipo==1:
                    ...
                    type_letters='ST'                    
                node_param.append(type_letters)

                try:
                    subprocess.run([node_path, printer_file, *node_param], creationflags=subprocess.CREATE_NO_WINDOW,check=True)
    ...
    def setupUi(self, base:QMainWindow, dni, database:ConectorDB):
        self.db= database
        self.dni = dni
        self.window3= base
