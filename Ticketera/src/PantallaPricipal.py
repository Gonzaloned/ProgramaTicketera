...
from TecladoDNI import TecladoDNI
from SeleccionTurno import Pantalla3

class PantallaPrincipal(object):    
    ...
    def crearVentanaSinDni(self):
        ...
        QTimer.singleShot(2000, lambda: self.ventana_teclado.close())
    ...
    def mostrarTeclado(self):
        self.teclado_UI= TecladoDNI()
        self.ventana_teclado= QMainWindow()
        self.teclado_UI.setupUi(self.ventana_teclado, self.db) #PASO LA CONEXION PARA NO CREAR UNA NUEVA EN CADA VENTANA

        self.ventana_teclado.setWindowFlags(Qt.FramelessWindowHint)
        self.ventana_teclado.setAttribute(Qt.WA_TranslucentBackground)
        self.ventana_teclado.setWindowModality(Qt.ApplicationModal)
        #self.animateOn(self.ventana_teclado)
        self.ventana_teclado.show()
...
"")
        ...
        self.pushButton = QPushButton(self.buttonDni, clicked = lambda: self.mostrarTeclado())
